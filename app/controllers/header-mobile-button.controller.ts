const iconMenu = document.querySelector<HTMLDivElement>(".mobile_menu .icon_menu")
const menuText = document.querySelector<HTMLDivElement>(".mobile_menu")
const menuTextElements = document.querySelectorAll<HTMLDivElement>(".mobile_menu li")
